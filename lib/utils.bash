...
# NOTE: You might want to remove this if lsd is not hosted on GitHub releases.
...
download_release() {
	...
	url="$GH_REPO/releases/download/${version}/lsd-${version}-${architecture}-${platform}.tar.gz"

	# TODO: Adapt the release URL convention for lsd
	# url="$GH_REPO/v${version}.tar.gz"
